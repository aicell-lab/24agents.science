      ...
      {user ? (
        <div className="space-y-4">
          <p className="text-gray-600">
            Generate a new API token to use with the 24Agents API.
          </p>
...
async def interact_with_model_zoo():
    ...
    model = await artifact_manager.read(
        artifact_id="24agents-science/affable-shark"
    )
      ...
      <div className="mb-8">
        ...
        <div className="prose max-w-none">
          <p className="text-gray-600 mb-4">
            The 24Agents backend is powered by <a href="https://docs.amun.ai" className="text-blue-600 hover:text-blue-800">Hypha</a>, 
      ...
      {activeMainTab === 'hypha-rpc' ? (
        <>
          <div className="mb-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-600 mb-4">
                Hypha RPC provides a modern, efficient way to interact with the 24Agents programmatically. 
...
server = await connect_to_server({
    ...
    token: "your-api-token-here"
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Here's a complete example showing how to interact with the 24Agents API:
            </p>
            <div className="bg-gray-50 rounded-lg p-4">
              <SyntaxHighlighter 
                language={activeLanguageTab} 
    ...
    console.error("Error reading model:", error);
        ...
        <div className="space-y-6">
          <div className="mb-8">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-600 mb-4">
                The HTTP REST API provides a traditional, stateless interface to interact with the 24Agents. 
          ...
          <div className="mb-4">
            <p className="text-gray-600 mb-4">
              <strong>Note:</strong> <code>&lt;artifact_alias&gt;</code> is the last part of the artifact ID (e.g., "affable-shark"), while the full <code>&lt;artifact_id&gt;</code> includes the workspace (e.g., "24agents-science/affable-shark").
            </p>
          </div>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-2">
              ...
              >
                GET https://hypha.aicell.io/24agents-science/artifacts/affable-shark
              </SyntaxHighlighter>
            </div>
            <p className="text-gray-600 mt-2">
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-2">
              ...
              >
                GET https://hypha.aicell.io/24agents-science/artifacts/24agents.science/children
              </SyntaxHighlighter>
            </div>
            <p className="text-gray-600 mt-2">
              <strong>Query Parameters:</strong>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-2">
              ...
              >
                GET https://hypha.aicell.io/24agents-science/artifacts/affable-shark/files/rdf.yaml
              </SyntaxHighlighter>
            </div>
            <p className="text-gray-600 mt-2">
              <strong>Query Parameters:</strong>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-2">
              ...
              >
                GET https://hypha.aicell.io/24agents-science/artifacts/affable-shark/create-zip-file
              </SyntaxHighlighter>
            </div>
            <p className="text-gray-600 mt-2">
              <strong>Query Parameters:</strong>
          ...
          <div>
            ...
            <div className="bg-gray-50 rounded-lg p-4 mb-2">
              ...
              >
                GET https://hypha.aicell.io/24agents-science/artifacts/affable-shark/zip-files/model.zip
              </SyntaxHighlighter>
            </div>
            <p className="text-gray-600 mt-2">
              <strong>Query Parameters:</strong>
...
GET https://hypha.aicell.io/public/services/artifact-manager/list?parent_id=24agents-science/24agents.science&limit=10
...
def download_model_files():
    ...
    # Get model details
    model_id = "24agents-science/affable-shark"
    response = requests.get(
