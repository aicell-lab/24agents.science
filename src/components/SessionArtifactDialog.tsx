        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex items-center gap-4 min-w-0 flex-1">
            ...
            <div className="min-w-0 flex-1">
              ...
              {currentArtifact?.gitUrl && (
                <div className="flex items-center gap-1.5 mt-1">
                  <svg className="w-3.5 h-3.5 text-purple-500 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <code className="text-xs text-purple-600 font-mono truncate">{currentArtifact.gitUrl}</code>
                  <button
                    onClick={() => {
                      navigator.clipboard.writeText(currentArtifact.gitUrl);
                      setStatusMessage({ type: 'success', text: 'Git URL copied to clipboard' });
                      setTimeout(() => setStatusMessage(null), 2000);
                    }}
                    className="p-1 text-purple-400 hover:text-purple-600 hover:bg-purple-50 rounded transition-colors flex-shrink-0"
                    title="Copy Git URL"
                  >
