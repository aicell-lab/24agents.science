              ...
              <div className="flex">
                ...
                <div className="ml-3 w-full">
                  ...
                  {viewMode === 'pending' && pendingCount > 0 && 
                    ...
                    <p className="mt-1">
                      {viewMode === 'published' ? 
                        "As a privileged reviewer, you can edit and manage all published models in the 24Agents. Any changes made will be immediately visible to users." : 
                        "As a privileged reviewer, your role is crucial in maintaining the quality and reliability of the 24Agents. Please review each submission carefully according to our guidelines."}
                    </p>
                  </div>
