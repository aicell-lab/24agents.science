...
- Use from **future** import annotations for forward references in type hints.
...
13. If there is no ruff.toml, recommend using Ruff and create a ruff.toml file if approved by the user.
